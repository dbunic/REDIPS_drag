...
query=query.substring(0,query.length-1);tables.sort(function(a,b){return b.redips_sort-a.redips_sort;});return query;};move_object=function(from,to){var i,childnodes_length;if(from===to){return;}
